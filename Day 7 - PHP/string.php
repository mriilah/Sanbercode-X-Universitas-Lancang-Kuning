...
<body>
    ...
    */
    ...
    echo "Panjang string: " . strlen($first_sentence) . " karakter<br>";
    echo "Jumlah kata: " . str_word_count($first_sentence) . " kata";
    // Panjang string 10, jumlah kata: 2
    $second_sentence = "I'm ready for the challenges";
    echo "<br>Panjang string: " . strlen($second_sentence) . " karakter<br>";
    echo "Jumlah kata: " . str_word_count($second_sentence) . " kata";
    ...
    echo "Kata pertama: " . substr($string2, 0, 1) . "<br>"; // Mengambil kata pertama
    echo "Kata kedua: " . substr($string2, 2, 5) . "<br>"; // Mengambil kata kedua
    echo "Kata ketiga: " . substr($string2, 6, 8) . "<br>"; // Mengambil kata ketiga
